<template>
  ...
  >
    ...
    >
      ...
      <template v-if="mode == 'tags'">
        <div :class="classList.tags" data-tags>
          ...
          <div ref="tags" :class="classList.tagsSearchWrapper">
    ...
    <div :class="classList.dropdown" tabindex="-1">
      ...
      <ul :id="ariaControls" :class="classList.options" role="listbox">
